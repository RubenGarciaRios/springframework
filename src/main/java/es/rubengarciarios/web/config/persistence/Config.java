...
@EnableJpaRepositories( basePackages = PackageList.JPA_REPOSITORIES, repositoryImplementationPostfix = "Impl" )
...
public class Config {
    ...
    public EntityManagerFactory entityManagerFactory( ) {
        ...
        entityManagerFactoryBean.setPackagesToScan( PackageList.JPA_ENTITIES );
